...
;//! \htmlinclude LightsData.msg.html

(cl:defclass <LightsData> (roslisp-msg-protocol:ros-message)
  ((spot_id
    :reader spot_id
    :initarg :spot_id
    :type cl:string
...
(cl:defclass LightsData (<LightsData>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LightsData>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LightsData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xhab_spot-msg:<LightsData> is deprecated: use xhab_spot-msg:LightsData instead.")))

(cl:ensure-generic-function 'spot_id-val :lambda-list '(m))
(cl:defmethod spot_id-val ((m <LightsData>))
...
(cl:defmethod timestamp-val ((m <LightsData>))
...
(cl:defmethod brightness-val ((m <LightsData>))
...
(cl:defmethod whites_on-val ((m <LightsData>))
...
(cl:defmethod reds_on-val ((m <LightsData>))
  ...
  (reds_on m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<LightsData>)))
    "Constants for message type '<LightsData>"
  '((:TARGET . lights))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'LightsData)))
    "Constants for message type 'LightsData"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LightsData>) ostream)
  "Serializes a message object of type '<LightsData>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LightsData>) istream)
  "Deserializes a message object of type '<LightsData>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LightsData>)))
  "Returns string type for a message object of type '<LightsData>"
  "xhab_spot/LightsData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LightsData)))
  "Returns string type for a message object of type 'LightsData"
  "xhab_spot/LightsData")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LightsData>)))
  "Returns md5sum for a message object of type '<LightsData>"
  "dc28d7a3fa71532943c24e8e4d0eacc8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LightsData)))
  "Returns md5sum for a message object of type 'LightsData"
  "dc28d7a3fa71532943c24e8e4d0eacc8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LightsData>)))
  "Returns full string definition for message of type '<LightsData>"
  (cl:format cl:nil "string spot_id~%string target = lights~%time timestamp~%float32 brightness~%bool whites_on~%bool reds_on~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LightsData)))
  "Returns full string definition for message of type 'LightsData"
  (cl:format cl:nil "string spot_id~%string target = lights~%time timestamp~%float32 brightness~%bool whites_on~%bool reds_on~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LightsData>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LightsData>))
