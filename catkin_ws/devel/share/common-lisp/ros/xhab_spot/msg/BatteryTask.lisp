...
(cl:defmethod cl:initialize-instance :after ((m <BatteryTask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryTask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xhab_spot-msg:<BatteryTask> is deprecated: use xhab_spot-msg:BatteryTask instead.")))

(cl:ensure-generic-function 'spot_id-val :lambda-list '(m))
(cl:defmethod spot_id-val ((m <BatteryTask>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BatteryTask>)))
  ...
  (cl:format cl:nil "string spot_id~%string target = battery~%time timestamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BatteryTask)))
  "Returns full string definition for message of type 'BatteryTask"
  (cl:format cl:nil "string spot_id~%string target = battery~%time timestamp~%~%~%"))
